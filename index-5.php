...
<html lang="en">
	...
	<body class="">
		<div id="bgStretch"><img src="images/bg_body1.jpg" alt=""></div>
<!--==============================header=================================-->
		<header>
					...
					<div class="grid_12">
						...
						<nav class="" >
							<ul class="sf-menu">
								...
								<li><a href="index-4.php">葡萄品种</a></li>
								<li class="current"><a href="index-5.php">联系我们</a></li>
							</ul>
						</nav>
						<div class="clear"></div>
					</div>
				...
				<div class="grid_9">
					<div class="content">
						<div class="grid_4 alpha">
							...
							<div class="map">
								<figure class="">
									<img src="images/map.jpg" height="400px" />
								</figure>
							</div>
						</div>
						<div class="grid_3 omega">
							<h3>联系我们</h3>
							<div class="style1">
								<h5>余姚临山味香园王建红葡萄庄园<br>
								联系人：王先生<br>
								联系电话： 158-2423-1255<br>
								联系地址：余姚市临山镇兰海村新庵一区8号
								<br><br>
								农庄葡萄已成熟，欢迎新老顾客前来采摘！
								</h5>
							</div>
